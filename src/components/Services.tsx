...
const services: Service[] = [
    {
        ...
        description:
        'End-to-end talent acquisition solutions designed to connect businesses with top-tier candidates. We leverage technology and industry insights to streamline the hiring process, improve retention rates, and build high-performing teams.',
        features: [
